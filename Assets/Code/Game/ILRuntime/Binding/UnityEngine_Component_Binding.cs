...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Component_Binding
    {
            ...
            if (genericMethods.TryGetValue("GetComponents", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(global::MonoBehaviourAdapter.Adaptor[])))
                    {
                        ...
                        app.RegisterCLRMethodRedirection(method, GetComponents_1);
        ...
        static StackObject* GetComponents_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
