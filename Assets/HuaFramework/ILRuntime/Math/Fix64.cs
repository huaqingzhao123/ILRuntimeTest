...
@"
    ...
    //[OdinDrawer]
    public class CustomFPDrawer : OdinValueDrawer<FP>
    {
        //protected override void DrawPropertyLayout(IPropertyValueEntry<FP> entry, GUIContent label)
        protected override void DrawPropertyLayout(GUIContent label)
        {
            FP value = ValueEntry.SmartValue;
            ...
            value = EditorGUI.FloatField(rect.AlignLeft(rect.width * 0.5f), "实际值", value.AsFloat());
            EditorGUI.LongField(rect.AlignRight(rect.width * 0.5f), "存储值", value.RawValue);
