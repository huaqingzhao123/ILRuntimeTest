...
namespace LitJson
{
    ...
    public class JsonMapper
    {
        ...
        static JsonMapper ()
        {
            ...
            ImporterFunc<long, FixedPoint64.FP> fpImporter =  (long input) =>
            {
                return FixedPoint64.FP.FromRaw(input);
            };

            RegisterImporter<long, FixedPoint64.FP>(fpImporter);

            ImporterFunc<Int32, FixedPoint64.FP> fpInt32Importer = (Int32 input) =>
            {               
                return FixedPoint64.FP.FromRaw(input);
            };

            RegisterImporter<Int32, FixedPoint64.FP>(fpInt32Importer);


            ExporterFunc<FixedPoint64.FP> fpExporter = delegate (FixedPoint64.FP fpValue, JsonWriter writer)
            {                
                writer.Write(fpValue.RawValue);
            };

            RegisterExporter<FixedPoint64.FP>(fpExporter);
        }
        #endregion
